...
- 🎓 Currently pursuing an **MSc in Cloud & High-Performance Computing** at Universitat Politècnica de València
- 💼 Former Software Developer & IT Manager with deep expertise in Ecosistemas Microsoft & Dynamics AX
- ⚡ Personal Signature: Bridging the gap between complex software architecture and business efficiency.

---

### 🛠️ Tech Stack & Tools

- **Backend:** .NET Core, C#, Web API, Python, Java (Learning)
- **Frontend:** Angular, TypeScript, JavaScript, Bootstrap
- **Data & ORM:** SQL Server, Entity Framework, LINQ, MySQL
- **Cloud & DevOps (Current Focus):** Docker, Kubernetes, CI/CD, Azure DevOps, AWS, Infrastructure as Code
- **ERP:** Microsoft Dynamics AX (X++)
